...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "navCollections".
 */
...
export interface Header {
  ...
  navItems?:
    | {
        ...
        navCollections?: (string | null) | NavCollection;
        id?: string | null;
      }[]
    | null;
  updatedAt?: string | null;
