  ...
  return (
    <Dialog>
      <DialogTrigger className="flex items-center " asChild>
        <button>
          <IoSearch className="font-bold h-5 w-5 transition-all hover:scale-100" />
        </button>
      </DialogTrigger>
        ...
        <div className="flex items-center justify-start flex-col">
          ...
          <form className="flex flex-col w-full md:w-[600px] justify-center mb-5">
            ...
            <div className="w-full relative">
              ...
              <Input
                className="px-8 pr-10 placeholder:text-stone-600"
                placeholder="Search"
                type="text"
                value={searKey ? searKey : ''}
                onChange={e => setSearchKey(e.target.value)}
              />
              {searKey && (
                <button
                  type="button"
                  className="absolute right-[20px] top-[50%] translate-y-[-50%] p-1 border border-stone-400 hover:border-stone-900"
                  onClick={() => setSearchKey(undefined)}
                >
            ...
            <div className="grid grid-cols-6">
              ...
              <div className="col-span-5 flex flex-col justify-start items-start">
                <h4 className="font-semibold flex items-center">
                  <FaFireAlt className="text-orange-600 h-4 w-4" />
                  Trending/Top selling <FaFireAlt className="text-orange-600 h-4 w-4" />
                </h4>
              </div>
            </div>
          </div>
